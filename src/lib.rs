// src/lib.rs
/*
 * Core library for TypeScriptChecker
 */
...
#[derive(Debug)]
pub struct TypeScriptCheckerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TypeScriptCheckerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TypeScriptChecker processing");
    
    let mut processor = TypeScriptCheckerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TypeScriptCheckerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TypeScriptCheckerProcessor::new(false);
